                ...
                <div class="col-md-10 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary">Manage student</button>
                            <p class="card-description">
                                {{-- Assign the teacher a classroom and subject. --}}
                            </p>
                            
                            <form class="forms-sample" action="{{ isset($teacher) ? '/teacher/update/'.$teacher->id : '/teacher/store_data' }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="classroom" class="col-sm-3 col-form-label">School</label>
                                        <div class="col-sm-9">
                                            <select id="classroom" name="classroom" class="form-control form-control-sm" data-dependent = 'subject' required>
                                                <option value="0">Select a School</option>
                                                @if(isset($subject))
                                                    @foreach($school as $classroom)
                                                        <option value="{{$classroom->id}}"
                                                            {{($subject->classroom->id== $classroom->id)? 'selected': ''}}>
                                                            {{$classroom->name}}
                                                        </option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="first_name" id="first_name" autofocus
                                                       placeholder="First Name" value="{{isset($teacher)? $teacher->first_name: old('first_name')}}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="surname" id="surname"
                                                       placeholder="Last Name" value="{{isset($teacher)? $teacher->surname: old('surname')}}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" name="birth_date" id="birth_date" min="01/01/1950"
                                                       placeholder="dd/mm/yyyy" value="{{isset($teacher)? $teacher->birth_date: old('birth_date')}}" required>
...
{{--                                <div class="row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="classroom" name="classroom" class="form-control form-control-sm" data-dependent = 'subject'>
                                                    <option value="" required>Select a Classroom</option>
                                                    @if(isset($teacher))
                                                        @foreach($classrooms as $classroom)
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="subject" class="col-sm-3 col-form-label" required>Subject</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="phone_number" id="phone_number"
                                                       placeholder="Enter Phone Number " value="{{isset($teacher)? $teacher->phone_number: old('phone_number')}}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" name="email" id="email"
                                                       placeholder="Email Address" value="{{isset($teacher)? $teacher->email: old('email')}}" required>
                                                @if ($errors->has('email'))
                                                    <div class="alert alert-danger">
                                                        {{$errors->first('email')}}
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="address" class="col-sm-1 col-form-label">Password</label>
                                            <div class="col-sm-11">
                                                <input type="password" style="resize: vertical;" rows="3" class="form-control" name="password" id="password" placeholder="password" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                <textarea type="text" style="resize: vertical;" rows="3" class="form-control" name="address" id="address"
                                                          placeholder="Address" required>{{isset($teacher)? $teacher->address: old('address')}}</textarea>
