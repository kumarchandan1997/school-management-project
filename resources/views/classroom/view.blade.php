                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" id="name" autofocus
                                                       placeholder="Name" value="{{isset($classroom)? $classroom->name: old('name')}}" required>
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea type="text" rows="3" class="form-control" name="description" placeholder="Description"
                                                          id="myTextarea" required>{{isset($classroom)? $classroom->description : old('description')}}</textarea>
